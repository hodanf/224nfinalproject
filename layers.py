...
class MultitaskBERT(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.similarity = torch.nn.Linear(SIZE_LAYER_1 * 2, 1) # read paper
...
def get_args():
    ...
    parser.add_argument("--sst_dev_out", type=str, default="predictions/sst-dev-output-layers.csv")
    parser.add_argument("--sst_test_out", type=str, default="predictions/sst-test-output-layers.csv")

    parser.add_argument("--para_dev_out", type=str, default="predictions/para-dev-output-layers.csv")
    parser.add_argument("--para_test_out", type=str, default="predictions/para-test-output-layers.csv")

    parser.add_argument("--sts_dev_out", type=str, default="predictions/sts-dev-output-layers.csv")
    parser.add_argument("--sts_test_out", type=str, default="predictions/sts-test-output-layers.csv")
...
if __name__ == "__main__":
    args = get_args()
    args.filepath = f'{args.option}-{args.epochs}-{args.lr}-multitask_layers.pt' # save path
